        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              {/* <h1 className="text-2xl font-bold text-gray-900">DreamRoad</h1> */}
            ...
            <h2 className="text-4xl font-bold text-gray-900">{isLogin ? "Login" : "Sign up"}</h2>
            <p className="text-gray-600">
              {isLogin ? "Find the job made for you!" : "Create your account to get started!"}
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500">{isLogin ? "Login" : "Sign up"} with Email</span>
            </div>
          </div>
              ...
              < div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    aria-describedby={errors.number ? "email-error" : undefined}
                  />
                  {errors.number ? (
                    <AlertCircle className="absolute right-3 top-3 h-4 w-4 text-red-500" />
                  ) : formData.email && validateNumber(formData.number) ? (
                    <CheckCircle2 className="absolute right-3 top-3 h-4 w-4 text-green-500" />
                  ) : null}
                </div>
                {errors.number && (
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <button
                ...
                className="text-[#255cf4] hover:underline font-medium transition-colors"
                disabled={isLoading}
              >
