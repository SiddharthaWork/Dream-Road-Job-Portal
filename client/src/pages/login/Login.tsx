        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500">Login with Email</span>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Not registered?{' '}
              <Link href="/register" className="text-[#255cf4] hover:underline font-medium transition-colors">
                Create an Account
              </Link>
            </p>
          </div>
