  ...
  return (
    <div className='w-full h-fit max-w-7xl mx-auto relative overflow-hidden '>
        <div className='h-[30rem] flex items-center '>
            ...
            <button onClick={() => router.push('/login')} className='px-6 h-10 rounded-md text-lg tracking-tight flex items-center gap-2 cursor-pointer font-semibold bg-[#255cf4] text-white '><Icon icon="game-icons:pointing" />Get Started Now</button>
            </div>
            </div>
