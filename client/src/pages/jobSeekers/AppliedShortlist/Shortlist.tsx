...
export default function ShortlistJobCard({ job, onJobClick, onApply, onSave, status, appliedDate }: JobCardProps) {
        ...
        <div className="flex items-start gap-4 mb-2">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 text-xs text-gray-500 flex-wrap">
              ...
              {status && (
                <Badge variant="outline" className="ml-2 bg-green-100 text-green-600 font-medium">
                  {status}
                </Badge>
              )}
            </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
          ...
          <div className="flex gap-2">
            <Button
              size="sm"
              onClick={handleApply}
              className="bg-green-100 text-green-600 px-4 py-2 font-medium"
            >
